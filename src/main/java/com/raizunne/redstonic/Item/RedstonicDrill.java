		...
		if (stack.stackTagCompound == null) {
			...
			if (Keyboard.isKeyDown(Keyboard.KEY_LSHIFT)) {
				...
				if (tag.getInteger("aug1") != 0) {
					list.add(EnumChatFormatting.YELLOW + Lang.translate("drill.augment") + ": " + EnumChatFormatting.DARK_GRAY + DrillUtil.getAugName(tag.getInteger("aug1")));
				}
				if (tag.getInteger("aug2") != 0) {
					list.add(EnumChatFormatting.YELLOW + Lang.translate("drill.augment") + ": " + EnumChatFormatting.DARK_GRAY + DrillUtil.getAugName(tag.getInteger("aug2")));
				}
				if (tag.getInteger("aug3") != 0) {
					list.add(EnumChatFormatting.YELLOW + Lang.translate("drill.augment") + ": " + EnumChatFormatting.DARK_GRAY + DrillUtil.getAugName(tag.getInteger("aug3")));
				}
				if (hasAugment(3, stack)) {
					list.add(EnumChatFormatting.RED + "Hotswap: " + EnumChatFormatting.GRAY + DrillUtil.getDrillHeadName(tag.getInteger("hotswapHead")) + " Drill Head");
				}
			} else {
...
//                player.openGui(Redstonic.instance, 5, world, (int)player.posX, (int)player.posY, (int)player.posZ);
	...
	public static float getBaseDigSpeed(ItemStack stack, Block block) {
		...
		switch (head) {
			...
			case 1:
				return 25F * multiplier;
			case 2:
				return 15F * multiplier;
			case 3:
				return 8F * multiplier;
			case 4:
